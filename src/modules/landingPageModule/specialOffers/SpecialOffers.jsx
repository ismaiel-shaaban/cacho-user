        ...
        <section className="container mt-[40px]">
            ...
            <div className="flex flex-col md:grid md:grid-cols-2 gap-[20px] md:h-[570px] mt-[40px]">
                <div className="rounded-md overflow-hidden md:h-auto h-[calc(570px/2)]">
                    <Image width={undefined} src={specialOffersData[0].image} alt={"Special Offers"} className="object-cover w-full h-full" />
                </div>
                <div className="flex flex-col md:grid md:grid-rows-2 md:h-[570px] gap-[20px]">
                    <div className="rounded-md overflow-hidden">
                        <Image width={undefined} src={specialOffersData[1].image} alt={"Special Offers"} className="object-cover w-full h-full" />
                    </div>
                    <div className="rounded-md overflow-hidden">
                        <Image width={undefined} src={specialOffersData[2].image} alt={"Special Offers"} className="object-cover w-full h-full" />
                    </div>
                </div>
            </div>
        </section>
