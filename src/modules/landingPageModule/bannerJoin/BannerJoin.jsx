    ...
    return (<section className="banner-join container mt-[46px]" dir={strings.getLanguage() === "ar" ? "rtl" : "ltr"}>
        <div
            ...
            <div className="h-full text-white py-[15px] px-[20px] md:py-[40px] md:px-[55px] md:w-3/5">
                ...
                <Button as={Link} href={"https://caco-dev.mimusoft.com/ar/vendors-hub/auth/register"} className="w-fit rounded-md text-white text-[20px] leading-6 tracking-wide font-[700] bg-[--primary-color] flex items-center mt-[24px]">{strings.SignUpFree}{strings.getLanguage() !== "ar" ? <FaArrowRight size={20} className="ms-2" /> : <FaArrowLeft size={20} className="ms-2" />}</Button>
            </div>
            <div
