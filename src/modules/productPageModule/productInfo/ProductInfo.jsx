    ...
    return (
        <>
            <div className="col-span-12 lg:col-span-4 md:col-span-6"
                ...
                {
                    info?.details && (
                        <div className={"w-full ms-auto flex flex-col gap-2 mt-3"}>
                            {Object.keys(info.details).map((key, index) => (
                                <div key={index}>
                                    ...
                                    <div className={"flex gap-2 flex-wrap"}>
                                        {info.details[key].map((detail, subIndex) => (
                                            <Button key={`${key}-${subIndex}`} radius={"sm"} size={"sm"} isIconOnly
                                                    ...
                                                    variant="bordered" style={{ backgroundColor: detail }}>{key !== "colors" && detail}</Button>
                                        ))}
                                    </div>
                                </div>
                            ))}
